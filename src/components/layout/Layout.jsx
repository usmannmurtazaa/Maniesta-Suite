...
export default function Layout({ children }) {
  ...
  // Motion props for background blobs – disabled for reduced motion
  const blob1Motion = prefersReducedMotion
    ? {}
    : {
  ...
  const blob2Motion = prefersReducedMotion
    ? {}
    : {
  ...
  const blob3Motion = prefersReducedMotion
    ? {}
    : {
