    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="glass-card p-6 md:p-8 rounded-2xl">
          <h1 className="text-3xl md:text-4xl font-bold text-gradient mb-2">Terms and Conditions</h1>
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Disclaimer of Warranties</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Accuracy of Calculations</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">External Links</h2>
              <p>We may link to third‑party websites. We are not responsible for their content or privacy practices.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Governing Law</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Contact</h2>
