    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="glass-card p-6 md:p-8 rounded-2xl">
          <h1 className="text-3xl md:text-4xl font-bold text-gradient mb-2">Export Guide – PDF & CSV Reports</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-8">Generate professional academic reports with one click.</p>

          <div className="space-y-8 text-gray-700 dark:text-gray-300">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Why Export Your Academic Data?</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">What’s Included in the Report?</h2>
              <div className="mb-4">
                <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">PDF Report Contents</h3>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">CSV File Contents</h3>
                <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Step‑by‑Step Walkthrough</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Using the CSV in Excel or Google Sheets</h2>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Troubleshooting</h2>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Privacy & Data Storage</h2>
