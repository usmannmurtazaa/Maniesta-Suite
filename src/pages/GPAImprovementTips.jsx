// src/pages/GPAImprovementTips.jsx
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="glass-card p-6 md:p-8 rounded-2xl">
          <h1 className="text-3xl md:text-4xl font-bold text-gradient mb-4">GPA Improvement Tips</h1>
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300">
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">1. Prioritise High‑Credit Courses</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">2. Use the Target GPA Calculator</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">3. Retake Courses (If Your School Allows)</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">4. Improve Study Habits</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">5. Manage Your Time Wisely</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">6. Monitor Your Progress</h2>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium">Can I improve my GPA in one semester?</h3>
                  <p>Yes – a strong semester (e.g., 3.8+) can significantly raise your CGPA, especially if you have fewer total credits so far.</p>
                </div>
                <div>
                  <h3 className="text-lg font-medium">Does withdrawing from a course affect GPA?</h3>
