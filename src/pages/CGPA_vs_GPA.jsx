    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        <div className="glass-card p-6 md:p-8 rounded-2xl">
          <h1 className="font-hero text-3xl md:text-4xl font-bold text-gradient mb-2">CGPA vs GPA – What’s the Difference?</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-8">Two important metrics every student should understand.</p>

          <div className="space-y-8 text-gray-700 dark:text-gray-300">
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">Definitions</h2>
              <div className="mb-4">
                <h3 className="font-heading text-lg font-medium text-gray-800 dark:text-gray-200 mb-1">What is GPA?</h3>
              ...
              <div>
                <h3 className="font-heading text-lg font-medium text-gray-800 dark:text-gray-200 mb-1">What is CGPA?</h3>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">Key Differences at a Glance</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">When to Use GPA vs CGPA</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="glass p-4 rounded-xl">
                  <h3 className="font-heading text-lg font-semibold mb-2 text-brand-500">Use GPA for…</h3>
                ...
                <div className="glass p-4 rounded-xl">
                  <h3 className="font-heading text-lg font-semibold mb-2 text-brand-500">Use CGPA for…</h3>
                  <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">How to Convert GPA to CGPA (and Vice Versa)</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">Example Scenarios</h2>
            ...
            <section>
              <h2 className="font-heading text-xl font-semibold mb-3 text-gray-900 dark:text-white">Why Both Matter for Students</h2>
              <ul className="list-disc pl-6 space-y-1">
